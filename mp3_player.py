...
Original file is located at
    https://colab.research.google.com/drive/1HZdPwj7QtysD4D43Y6F2DLh8gJ26VE6l
"""
...
def next_song():
	...
	song_name = playlist_box.get(next_one)
...
def About():
        messagebox.showinfo("information",'''This is a simple music player app developed by BHARAT CHANDRA.\nThis is used to add one or more mp3 songs to playlist and listen to them.\nIt has basic features like play,pause,stop,swapping to next song/previous song and also volume contolls and audio skipping to listen a bit of song at particular time instance.\n\ncontact : bharat.chandra200@gmail.com''')
# Create main Frame
main_frame = Frame(root)
main_frame.pack(pady=20)

# Create Playlist Box
playlist_box = Listbox(main_frame, bg="white", fg="green", width=60, selectbackground="lightblue", selectforeground='black')
...
back_button = Button(control_frame,borderwidth=0,text='previous song', command=previous_song,bg='lightblue')
forward_button = Button(control_frame, borderwidth=0,text='next song', command=next_song,bg='lightblue')
play_button = Button(control_frame,borderwidth=0,text='play', command=lambda :play(song),bg='green')
pause_button = Button(control_frame, borderwidth=0,text='pause', command=lambda: pause(paused),bg='yellow')
stop_button = Button(control_frame, borderwidth=0,text='stop', command=stop,bg='red')
...
music = PhotoImage(file='images\\hi.png')

# Temporary Label
global my_label
my_label = Label(root,image=music)
